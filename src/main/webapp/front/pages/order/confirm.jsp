				...
				<table class="layui-table" lay-skin="nob" style="border: 3px dotted #EEEEEE;margin: 20px 0;">
					...
					<tbody>
						<tr v-for="(item,index) in dataList" v-bind:key="index">
							...
							<td v-else style="width: 100px;">{{item.price}} RMB</td>
							...
							<td v-else-if="seat==1"  style="width: 100px;">{{item.total}} RMB</td>
							<td v-else  style="width: 100px;">{{item.price*item.buynumber}} RMB</td>
						</tr>
					</tbody>
				</table>
