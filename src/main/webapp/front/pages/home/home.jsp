...
<body>
    ...
    <div class="plate">
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in laoshiRecommend" v-bind:key="index">
                <a target="_self" :href="'../laoshi/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.imgPhoto" width="385" height="220" />
                  </div>
                  <div class="remark">
                    <h5>{{item.name}}</h5>
                  </div>
              ...
              <ul class="wul105">
                <li v-for="(item,index) in newsList" v-bind:key="index">
                  <span class="bor-img click-more-team">
                    <img :src="item.imgPhoto" width="100" height="100" />
                  </span>
                  <div class="remark">
                    <h5>{{item.title}}</h5>
                    <span>{{item.addtime}}</span>
                    <p class="desc">{{item.noticeContent|newsDesc}}...</p>
                  ...
                  <div class="dask-team hide">
                    ...
                    <div class="dask-remark">
                      <div class="t-left fl">
                        <img :src="item.imgPhoto" width="280" height="280" />
                      </div>
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in keyanList" v-bind:key="index">
                <a target="_self" :href="'../keyan/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.imgPhoto" width="385" height="220" />
                  </div>
                  <div class="remark">
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`laoshi/page`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.laoshiRecommend = res.data.list;
      });

      http.request(`keyan/page`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.keyanList = res.data.list;
      });
    });
  </script>
</body>
