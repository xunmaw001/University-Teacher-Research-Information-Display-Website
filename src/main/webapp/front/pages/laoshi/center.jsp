				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="mima" id="mima" placeholder="密码" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<select name="xingbie" id="xingbie">
									...
									<option v-for="(item,index) in xingbie" v-bind:key="index" :value="item">{{item}}</option>
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
								<img id="touxiangImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" src="../../img/avator.png">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<select name="keshi" id="keshi">
									<option value="">请选择</option>
									<option v-for="(item,index) in keshi" v-bind:key="index" :value="item">{{item}}</option>
								</select>
							</div>
						</div>
                                                                                                <div class="layui-form-item">
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
																								...
																								http.request(`option/keshi/keshi`,'get',{},(res)=>{
					vue.keshi = res.data
				});
