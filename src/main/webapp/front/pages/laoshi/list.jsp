          ...
          <form class="layui-form">
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="name" id="name" placeholder="老师名称" autocomplete="off" class="layui-input">
              </div>
            </div>
            <div class="layui-inline" style="margin-bottom: 10px;">
              <label class="layui-form-label">地区</label>
              <div class="layui-input-inline">
                <input type="text" name="area" id="area" placeholder="地区" autocomplete="off" class="layui-input">
              </div>
            </div>
            <div class="layui-inline" style="margin-bottom: 10px;">
              <label class="layui-form-label">学院</label>
              <div class="layui-input-inline">
                <input type="text" name="xyTypes" id="xyTypes" placeholder="学院" autocomplete="off" class="layui-input">
            </div>
            </div>
            <div class="layui-inline" style="margin-bottom: 10px;">
              <label class="layui-form-label">院系</label>
              <div class="layui-input-inline">
                  <input type="text" name="yxTypes" id="yxTypes" placeholder="院系" autocomplete="off" class="layui-input">
                </select>
              </div>
            </div>
            ...
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('yisheng','新增')" @click="jump('../yisheng/add.jsp')" type="button" class="layui-btn btn-theme">
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../laoshi/detail.jsp?id='+item.id">
                <div class="posi-img">
                  <img :src="item.imgPhoto" width="100%">
                </div>
                  <div class="remark">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#area').val()) {
          param['area'] = jquery('#area').val()
        }  
        if (jquery('#xyTypes').val()) {
          param['xyname'] = jquery('#xyTypes').val()
        }
        if (jquery('#yxTypes').val()) {
          param['yxname'] = jquery('#yxTypes').val()
        }
        // 获取列表数据
        http.request('laoshi/page', 'get', param, function(res) {
