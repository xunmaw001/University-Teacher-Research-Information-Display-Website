                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                   ...
                                   <div class="form-group col-md-6">
                                       <label>轮播图</label>
                                       <img id="idcardPhotoImg" src="" width="100" height="100">
                                       <input name="file" type="file" id="idcardPhotoupload"
                                              class="form-control-file">
                                       <input name="idcardPhoto" id="idcardPhoto" type="hidden">
                                   </div>
...
<script>
    ...
    // 文件上传
    function upload() {
        $('#idcardPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= baseUrl + 'file/download?fileName=' + data.result.file;
                document.getElementById('idcardPhotoImg').setAttribute('value',photoUrl);
                document.getElementById('idcardPhoto').setAttribute('value',photoUrl);
            }
        });
    ...
    //图片显示
    function showImg() {
        $("#idcardPhotoImg").attr("src",ruleForm.idcardPhoto);
    }
